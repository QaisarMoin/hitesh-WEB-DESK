...
//  .assign() ke andar jo pehla object hoga wo target object hota hai ussi me sab add ho jayenge
// console.log(obj5);
...
//it return value in the form of array
...
let course = {
  coursename: "js hindi",
  price: "999",
  courseInstructor: "QaisarTeacher",
};

//if we want to print any key and value from the object we can do log(course.courseInstructor)  but baar baar aesa likhna accha nahi hai

//iss ke liye ek second method bhi hai jis mehtod se ham key name ko ek ne name se bhi bula sakte hai and value call kare ne liye direct key ka naam likhne ka baar baar course.key course.key nahi likho
