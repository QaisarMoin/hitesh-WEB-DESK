...
function handelObject(anyObject) {
  console.log(
    `Hello! I am ${anyObject.username} , My coaching price is ${anyObject.price} call me on my number ${anyObject.mobile_no} `
  );
}

handelObject(user);
//we can pass the pre defined object into function
